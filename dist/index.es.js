...
var b = (e, t, r) => (Y(e, typeof t != "symbol" ? t + "" : t, r), r), j = (e, t, r) => {
  if (!t.has(e))
...
class rt {
  ...
  remove() {
    var t, r, n;
    ((r = (t = this.parentItem) == null ? void 0 : t.firstChildItem) == null ? void 0 : r.id) == this.id && u(this.parentItem, A, s(this, f)), this.previousItem && u(this.previousItem, f, s(this, f)), this.nextItem && u(this.nextItem, g, s(this, g)), u(this, m, void 0), u(this, f, void 0), u(this, g, void 0), (n = s(this, C)) == null || n.remove();
  }
  append(t) {
    if (t.id == this.id)
    ...
    u(t, m, this), n ? n.after(t) : (u(this, A, t), this.target.append(t.target));
  }
  before(t) {
    if (t.id == this.id)
      throw new Error("Cannot append item before itself");
    t.remove(), u(t, g, this.previousItem), this.previousItem ? u(this.previousItem, f, t) : this.parentItem && u(this.parentItem, A, t), u(t, m, this.parentItem), u(t, f, this), u(this, g, t), this.target.before(t.target);
  }
  after(t) {
    if (t.id == this.id)
      throw new Error("Cannot append item before itself");
    t.remove(), u(t, f, this.nextItem), this.nextItem && u(this.nextItem, g, t), u(t, m, this.parentItem), u(t, g, this), u(this, f, t), this.target.after(t.target);
  }
}
D = new WeakMap(), B = new WeakMap(), m = new WeakMap(), A = new WeakMap(), f = new WeakMap(), g = new WeakMap(), C = new WeakMap();
function F(e, t, r) {
...
class nt {
  ...
  get activeItem() {
    if (document.activeElement != null)
      return Z(s(this, p), document.activeElement);
  }
  get value() {
    return P(s(this, p));
  }
  set value(t) {
    if (K(t), J(t).length != t.length)
      throw new Error("Cannot set value, invalid linked list");
    const n = s(this, p);
    t.forEach((i, h) => {
      this.upsert(i), h == 0 && (s(this, k).replaceChildren(s(this, p).target), n == null || n.remove());
    });
  }
  upsert(t) {
    u(this, p, G(t, s(this, p), () => this.createItem(t.type, t.id, t.data)));
  }
  getItemById(t) {
    return S(s(this, p), t);
  }
...
const Et = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  getNextOrChildByTarget: Z,
  getNextSiblings: V,
  sortList: J,
  upsertAndReturnRoot: G,
  validateList: K
...
function ct(e) {
  ...
  function h(o) {
    ...
    r < t.length - 1 && t.splice(r, t.length - r), t.push({
      ...
      BeforeUndo: () => {
        var a;
        return (a = o.BeforeUndo) == null ? void 0 : a.call(o);
      },
      OnUndo: () => {
        var a;
        return (a = o.OnUndo) == null ? void 0 : a.call(o);
      },
      Redo: () => o.Action(),
      BeforeRedo: () => {
        var a;
        return (a = o.BeforeAction) == null ? void 0 : a.call(o);
      },
      OnRedo: () => {
        var a;
        return (a = o.OnAction) == null ? void 0 : a.call(o);
      }
...
class St {
  ...
  handleKeystroke(t, r) {
    s(this, U).push(Q(r.ctrl, r.shift, r.alt, r.key));
